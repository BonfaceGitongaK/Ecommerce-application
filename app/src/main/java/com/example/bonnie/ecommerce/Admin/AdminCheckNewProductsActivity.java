package com.example.bonnie.ecommerce.Admin;
...
import com.example.bonnie.ecommerce.Interface.ItemClickListener;
...
public class AdminCheckNewProductsActivity extends AppCompatActivity
{
    ...
    private void ChangeProductState(String productID)
    {
        unverifiedProductsRef.child(productID)
            ...
            {
                Toast.makeText(AdminCheckNewProductsActivity.this, "The item has been approved. It is now available for sale'", Toast.LENGTH_SHORT).show();
            }
        });
    }
}